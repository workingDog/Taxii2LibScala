...
To use the latest release (from Maven Central) add the following dependency to your *build.sbt*:
    ...
    libraryDependencies += "com.github.workingDog" %% "taxii2lib" % "0.5"
...
This will produce a jar file "taxii2lib_2.12-0.6-SNAPSHOT.jar" in the "./target/scala-2.12" directory 
...
Then put this in your Scala app *build.sbt* file
    ...
    libraryDependencies += "com.github.workingDog" %% "taxii2lib" % "0.6-SNAPSHOT" 
